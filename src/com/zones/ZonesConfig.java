...
public class ZonesConfig {
    ...
    public static final String PLAYER_CLAIMES_ZONES = ChatColor.GREEN + "You are now the proud owner of {zname}!";
    public static final String PLAYER_ALREADY_CLAIMED_ZONE = ChatColor.RED + "You have already claimed a zone in {zname}!";
    public static final String PLAYER_CAN_DIE_IN_ZONE = ChatColor.RED + "WARNING: you can die in this zone!";
    
    public static final String PLAYER_ENTERED_ZONE = ChatColor.YELLOW + "Player {pname}" + ChatColor.YELLOW + " has entered {zname}.";
    public static final String PLAYER_LEFT_ZONE = ChatColor.YELLOW + "Player {pname}" + ChatColor.YELLOW + " has left {zname}.";
