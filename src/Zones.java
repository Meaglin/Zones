...
public class Zones extends Plugin {
	...
	public static final int	_Rev	= 16;
	...
	public void initialize() {
		...
		etc.getLoader().addListener(PluginLoader.Hook.BLOCK_CREATED, list, this, PluginListener.Priority.HIGH);
		etc.getLoader().addListener(PluginLoader.Hook.BLOCK_DESTROYED, list, this, PluginListener.Priority.HIGH);
